...
**Вариант 1** В файле `problems/knapsack_problem/genetic_solver.py` необходимо реализовать метод *get_knapsack* класса *GeneticSolver* для поиска набора вещей рюкзака максимальной стоимости с применением генетического алгоритма, остановку алгоритма реализовать по счетчику количества популяций.

**Вариант 2** В файле `problems/napsack_problem/genetic_solver.py` необходимо реализовать метод *get_knapsack* класса *GeneticSolver* для поиска набора вещей рюкзака максимальной стоимости с применением генетического алгоритма, остановку алгоритма реализовать по несменяемости лидера.

**Вариант 3** В файле `problems/knapsack_problem/genetic_solver.py` необходимо реализовать метод *get_knapsack* класса *GeneticSolver* для поиска набора вещей рюкзака максимальной стоимости с применением генетического алгоритма, реализовать выбор особей для скрещивания турниром.

**Вариант 4** В файле `problems/knapsack_problem/genetic_solver.py` необходимо реализовать метод *get_knapsack* класса *GeneticSolver* для поиска набора вещей рюкзака максимальной стоимости с применением генетического алгоритма, реализовать выбор особей для скрещивания рулеткой.
